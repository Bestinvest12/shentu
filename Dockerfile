...
WORKDIR /root
COPY --from=go-builder /go/src/github.com/certikfoundation/shentu/build/certikd /usr/local/bin/certikd
COPY --from=go-builder /go/src/github.com/certikfoundation/shentu/build/certikcli /usr/local/bin/certikcli
